...
class RobotDialogueBox(PopupBox):
    ...
    def create_prev_button(self):
        ...
        pygame.draw.rect(self.surface, view_cst.PARCHMENT_COLOR, prev_button_rect)
    ...
    def create_next_button(self):
        ...
        pygame.draw.rect(self.surface, view_cst.PARCHMENT_COLOR, next_button_rect)
    ...
    def create_accept_decline_buttons(self):
        ...
        pygame.draw.rect(self.surface, view_cst.PARCHMENT_COLOR, accept_button_rect)
        ...
        pygame.draw.rect(self.surface, view_cst.PARCHMENT_COLOR, decline_button_rect)
    ...
    def create_end_quest_button(self):
        ...
        pygame.draw.rect(self.surface, view_cst.PARCHMENT_COLOR, end_quest_button_rect)
